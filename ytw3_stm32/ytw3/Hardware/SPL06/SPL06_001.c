...
//	dat = IIC_Read_One_Byte(&SPL_bus, SPL_CHIP_ADDRESS,addr);
    HAL_I2C_Mem_Read(&hi2c3, (SPL_CHIP_ADDRESS << 1)+1, addr, I2C_MEMADD_SIZE_8BIT, &dat, 1, HAL_I2C_ERROR_TIMEOUT);
	return dat;
}
...
//	IIC_Write_One_Byte(&SPL_bus, SPL_CHIP_ADDRESS,addr,dat);
    HAL_I2C_Mem_Read(&hi2c3, SPL_CHIP_ADDRESS << 1, addr, I2C_MEMADD_SIZE_8BIT, &dat, 1, HAL_I2C_ERROR_TIMEOUT);
}
